...
<header>
   ...
   <nav id="mainNav">
        ...
        <div class="my-slider">
            <ul>
                <li id="slide1"><img src="./assets/img/sliderimages/hennabowl.jpg"></li>
                <li id="slide2"><img src="./assets/img/sliderimages/hennapartial.jpg"></li>
                <li id="slide2"><img src="./assets/img/sliderimages/hennaspread.jpg"></li>
            </ul>
        </div>


       <div id="productsTitle">
            <p class="productTitle">Henna Hair Dye</p>
            <p id="productDesc">Using henna to color hair is a fabulous natural alternative to synthetic dyes, and it’s a cinch to get sensational results. Each color is expertly blended with henna, essential oils and deeply conditioning cocoa butter, so your hair will be left looking and feeling fabulous.</p>
            <hr>
            <br>
            <br>
        </div>
            ...
            <div class="grid-container wrapperProductsPage">
                    ...
                    <div class="grid-item">
                        <a href="item.php?category=henna_hair_dye&product=<?php echo $slug;?>">
