...
<header>
   ...
   <nav id="mainNav">
        ...
        <div class="my-slider">
            <ul>
                <li id="slide1"><img src="./assets/img/sliderimages/pinkscrub.jpg"></li>
                <li id="slide2"><img src="./assets/img/sliderimages/honeyscrub.jpg"></li>
                <li id="slide2"><img src="./assets/img/sliderimages/deskpinkscrub.jpg"></li>
            </ul>
        </div>


       <div id="productsTitle">
            <p class="productTitle">Lipscrubs</p>
            <p id="productDesc">We like to keep our lips perfectly soft at all times; you never know when you might need to pucker up. Keep your kisser ready and protected from the elements with our selection of delectable, rich lip balms and tints, and sweet lip scrubs.</p>
            <hr>
            <br>
            <br>
        </div>
            ...
            <div class="grid-container wrapperProductsPage">
                    ...
                    <div class="grid-item">
                        <a href="item.php?category=lipscrub&product=<?php echo $slug;?>">
